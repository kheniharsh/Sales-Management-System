<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home_manager.aspx.cs" Inherits="SalesManagementSystem.home_manager" %>
...
<body style="margin:auto; height:auto; background-image:url(img/back.jpg); background-repeat:no-repeat; background-size:100% 100%;">
    ...
    <div class="nav" style="height: 15px; text-align: center; background-color:#37475A; padding-top:10px; padding-bottom:15px; width:auto;">
     ...
     <div style="padding-top:149px; height:480px;">
         <asp:Label ID="Label1" class="label" runat="server" Text="Welcome Manager: " style="position:absolute; top: 370px; left: 600px; font-weight: 700; font-size: xx-large; color: #000000;border-bottom:solid #000000; border-radius:8px;  animation: mymove 3s infinite; text-shadow: 2px 2px 5px #f01717;"><asp:Label ID="Label3" runat="server"  style="font-weight: 700; font-size: xx-large; color: #000000;">!</asp:Label></asp:Label>
